...
function updateGuy(dt){
  ...
  if(walking)walkPhase+=dt*Math.min(38,11+walkAmt*1.05);
  ...
  if(climbing&&contactHold){
    ...
    const stride=sprinting?0.58:0.43;
    const lift=sprinting?0.19:0.14;
